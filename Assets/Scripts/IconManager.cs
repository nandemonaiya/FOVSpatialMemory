...
public class IconManager : MonoBehaviour
{
    ...
    LabelLanguage m_currentLang = LabelLanguage.None;
   ...
   void ChangeMode (Mode currentMode)
    ...
    void InitObjects()
    {
        ...
        m_frontWall = transform.parent.Find("FrontWall").GetComponent<MeshCollider>();
        m_leftWall =  transform.parent.Find("LeftWall").GetComponent<MeshCollider>();
        m_rightWall = transform.parent.Find("RightWall").GetComponent<MeshCollider>();

        //Load all the game object positions with the tag "Set A" or "Set B" in the list of possible positions
        foreach (Transform child in transform.parent.Find("Front").transform)
        {
        ...
        foreach (Transform child in transform.parent.Find("Left").transform)
        {
            if (child.gameObject.tag == m_currentTag)
            {
                m_pointObjs.Add(child.gameObject);
        ...
        foreach (Transform child in transform.parent.Find("Right").transform)
        {
            if (child.gameObject.tag == m_currentTag)
            {
                m_pointObjs.Add(child.gameObject);
